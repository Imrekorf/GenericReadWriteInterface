...
#### lvalue
```c++
/** SUPPORTS: Any lvalue excluding pointers and arrays, containers, iterators and streams */
std::size_t write(const Type&    buffer);
std::size_t write(const iIOable& buffer);
...
/** SUPPORTS: ptrType: Any pointer excluding pointer pointers, pointers to arrays, containers, pointers to containers and iterators 
 *  SUPPORTS: Type: any lvalue excluding pointers, arrays, containers and iterators
*/
